...
var Highlighter = React.createClass({displayName: "Highlighter",
  ...
  renderPlain: function(string) {
    this.count++;
    return React.DOM.span({'key': this.count,
                           'data-identification':this.props['data-identification'],
                           'data-textValue':this.props['data-textValue']}, string);
  },
  ...
  renderHighlight: function(string) {
    ...
    return React.DOM[this.props.matchElement]({
      'data-identification':this.props['data-identification'],
      'data-textValue':this.props['data-textValue'],
      key: this.count,
